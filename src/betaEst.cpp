...
//[[Rcpp::export]]
double betaEst(std::vector<std::string> fam_group, Rcpp::NumericVector alpha,
               Rcpp::NumericVector dtime, Rcpp::NumericVector delta,
               Rcpp::NumericVector g, double var,
  ...
  */
  ...
  Result res = boost::math::tools::brent_find_minima(
      std::bind(fam_LLBeta, _1, famsize, dt, Delta, G, m, f_ind), lower, upper,
      15);
